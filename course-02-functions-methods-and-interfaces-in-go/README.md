...
### Animal Information (hardcoded data)
...
`cd week3/01-animalinfo && go run ./animalinfo.go`

##### Option 2

`cd week3/01-animalinfo && go build ./animalinfo.go && ./animalinfo`

## Week-04

### Animal Information (dynamic data)
...
`cd week4/01-animalinfo && go run ./animalinfo.go`

##### Option 2

`cd week4/01-animalinfo && go build ./animalinfo.go && ./animalinfo`